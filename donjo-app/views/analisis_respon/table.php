...
<div id="contentpane">
	...
	<div class="left">
		...
		<a href="<?php echo site_url("analisis_respon/form_impor_bdt")?>" class="uibutton special tipsy south" title="Impor Data BDT 2015" target="ajax-modal" rel="window" header="Impor Data BDT 2015xx" modalHeight="auto"><span class="fa fa-upload">&nbsp;</span>Impor BDT 2015</a>
	</div>
	<div class="right">
